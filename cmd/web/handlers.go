...
import (
	...
	"github.com/oscargsdev/snippetbox/internal/models"
	"github.com/oscargsdev/snippetbox/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365), "exprires", "This field must equal 1, 7 or 365")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Email), "email", "This files cannot be blank")
